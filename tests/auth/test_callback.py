...
from wristband.django_auth.models import AuthConfig, CallbackResultType, TokenResponse, UserInfo
...
class TestWristbandAuthCallback:
    ...
    def test_callback_missing_state_raises_error(self) -> None:
        ...
        request = self.factory.get("/callback?code=auth_code&tenant_domain=tenant1")
    ...
    def test_callback_empty_state_raises_error(self) -> None:
        ...
        request = self.factory.get("/callback?code=auth_code&state=&tenant_domain=tenant1")
    ...
    def test_callback_missing_tenant_domain_with_subdomain_parsing_raises_error(self) -> None:
    ...
    def test_callback_missing_tenant_domain_without_subdomain_parsing_raises_error(self) -> None:
    ...
    def test_callback_with_error_login_required_returns_redirect(self) -> None:
        ...
        request = self.factory.get("/callback?error=login_required&state=test_state&tenant_domain=tenant1")
    ...
    def test_callback_with_other_error_raises_wristband_error(self) -> None:
        ...
        request = self.factory.get(
            "/callback?error=access_denied&error_description=User denied access&state=test_state&tenant_domain=tenant1"
        )
    ...
    def test_callback_with_error_no_description_uses_empty_string(self) -> None:
        ...
        request = self.factory.get("/callback?error=access_denied&state=test_state&tenant_domain=tenant1")
    ...
    def test_callback_mismatched_state_returns_redirect(self) -> None:
        ...
        request = self.factory.get("/callback?code=auth_code&state=param_state&tenant_domain=tenant1")
    ...
    def test_callback_missing_code_after_validation_raises_error(self) -> None:
        ...
        request = self.factory.get("/callback?state=test_state&tenant_domain=tenant1")  # No code param
    ...
    def test_callback_with_tenant_custom_domain_param(self, mock_time) -> None:
        ...
        request = self.factory.get(
            "/callback?code=auth_code&state=test_state&tenant_domain=tenant1&tenant_custom_domain=custom.tenant.com"
        )
    ...
    def test_callback_invalid_grant_error_returns_redirect(self) -> None:
        ...
        request = self.factory.get("/callback?code=invalid_code&state=test_state&tenant_domain=tenant1")
    ...
    def test_callback_duplicate_query_parameters_raise_error(self) -> None:
        ...
        request = self.factory.get(
            "/callback?code=auth_code&code=duplicate_code&state=test_state&tenant_domain=tenant1"
        )
